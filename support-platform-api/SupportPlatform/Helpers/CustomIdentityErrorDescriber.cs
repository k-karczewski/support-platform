...
namespace SupportPlatform.Helpers
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordMismatch() { return new IdentityError { Code = nameof(PasswordMismatch), Description = "Nazwa użytkownika bądź hasło są niepoprawne." }; }
        ...
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"Nazwa użytkownika '{userName}' jest niepoprawna (musi zawierać jedynie litery i cyfry)." }; }
        ...
        public override IdentityError PasswordTooShort(int length) { return new IdentityError { Code = nameof(PasswordTooShort), Description = $"Hasło musi zawierać conajmniej {length} znaków." }; }
    }
}
